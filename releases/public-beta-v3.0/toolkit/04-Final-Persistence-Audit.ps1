...
<##
Read-only final persistence audit for the v3.0 RC2zk validation candidate.
...
$EvidenceRoot = Join-Path "$env:USERPROFILE\Downloads" ('LegionGo-AMD-26.7.1-v3.0-RC2zk-Final-Audit-' + $Timestamp)
...
function Write-Stage4Result {
    ...
    $Result = [ordered]@{
        Schema = 'LegionGo-AMD-26.7.1-v3.0-RC2zk-Stage4Result'
        Release = $Version
...
Write-Section 'LEGION GO AMD 26.7.1 v3.0 RC2zk - FINAL READ-ONLY AUDIT'
