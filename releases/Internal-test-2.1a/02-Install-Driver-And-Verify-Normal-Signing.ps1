...
$EmbeddedPayload = [ordered]@{
    ...
    'Phase-01-Install-Corrected-Driver.ps1' = [ordered]@{
        SHA256 = '8D55A37C399F7412A4F5D5A09260701F081256B23768E43227409ECD4E383CDA'
        Utf8Bom = $true
        LineEnding = 'CRLF'
...
try {
    ...
    if (
        ...
        throw (
            'The starting AMD display package is not recorded by Windows ' +
            'as a signed driver package.'
        )
    }
