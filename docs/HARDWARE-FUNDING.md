...
Public Beta v4.5 has three exact released hardware profiles. A marketing-family name alone is not enough to establish support.
...
|---|---|---|---|
| Legion Go 1 Z1 Extreme | `PCI\VEN_1002&DEV_15BF&SUBSYS_381217AA&REV_04` | Released | Public Beta v4.5; combined public package 78/78 |
| Legion Go S Z1 Extreme | `PCI\VEN_1002&DEV_15BF&SUBSYS_380C17AA&REV_04` | Released | Public Beta v4.5; volunteer hardware 81/81 |
| Legion Go 2 Z2 Extreme | `PCI\VEN_1002&DEV_150E&SUBSYS_381C17AA&REV_C5` | Released | Public Beta v4.5; volunteer hardware 79/79 |
...
Examples include non-Extreme Go 1 variants, non-Z1-Extreme Go S variants, Go 2 AI Extreme, and other Go 2 revisions. Go 2 `REV_C4` is explicitly rejected by the v4.5 public resolver fixture.
